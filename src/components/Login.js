      ...
      <div className="flex-1 flex flex-col md:flex-row">
        ...
        >
          <div className="w-full max-w-sm bg-white rounded-2xl shadow-lg p-8 relative">
            ...
            <button className="absolute top-4 right-4 text-gray-400 hover:text-red-500 text-2xl" onClick={() => navigate("/")} aria-label="Close login form">
              &times;
            </button>
            <h1 className="text-2xl font-bold text-orange-500 mb-2">Sign In</h1>
            <p className="text-gray-500 text-sm mb-6">Welcome back! Please login to your account.</p>
            <form className="w-full space-y-4" onSubmit={handleSubmit} autoComplete="off" aria-label="Login form">
              <div>
                <label className="block text-xs text-gray-500 mb-1" htmlFor="login-username">Username or Email</label>
                <input
                  id="login-username"
                  type="text"
              ...
              <div>
                <label className="block text-xs text-gray-500 mb-1" htmlFor="login-password">Password</label>
              ...
              <div className="flex justify-between items-center text-xs mt-2">
                <button type="button" className="text-orange-500 hover:underline" onClick={() => alert('Forgot Password?')}>Forgot Password?</button>
              </div>
              <Button type="submit" className="w-full mt-4" ariaLabel="Login">Login</Button>
            </form>
            ...
            <Button className="w-full flex items-center justify-center gap-2 bg-gray-100 text-gray-700 text-sm font-medium hover:bg-gray-200" ariaLabel="Login with Facebook">
            ...
            <div className="flex justify-center mt-4 text-sm">
              ...
              <button className="ml-2 text-orange-500 hover:underline" onClick={() => navigate("/register")}>Register</button>
            </div>
          </div>
        </motion.div>
      </div>
