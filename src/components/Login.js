    ...
    <div className="flex min-h-screen bg-gray-50">
      ...
      <div className="flex flex-col justify-center items-center w-full md:w-1/3 bg-gray-50 p-6 relative">
        <div className="w-full max-w-sm bg-white rounded-2xl shadow p-8 relative">
          ...
          <h1 className="text-2xl font-bold text-blue-600 mb-2">Sign In</h1>
          ...
          <form className="w-full space-y-4" onSubmit={handleSubmit} autoComplete="off">
            ...
            <div className="flex justify-between items-center text-xs mt-2">
              <button type="button" className="text-blue-600 hover:underline" onClick={() => alert('Forgot Password?')}>Forgot Password?</button>
            </div>
            <button type="submit" className="w-full py-2 bg-blue-600 text-white rounded-full font-semibold mt-4 hover:bg-blue-700 transition">Login</button>
          </form>
          ...
          <div className="flex justify-center mt-4 text-sm">
            ...
            <button className="ml-2 text-blue-600 hover:underline" onClick={() => navigate("/register")}>Register</button>
          </div>
        </div>
      </div>
    </div>
