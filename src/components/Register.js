  ...
  return (
    <div className="flex min-h-screen">
      ...
      <div className="flex flex-col justify-center items-center w-full md:w-1/3 bg-white p-8 relative">
        ...
        <p className="text-gray-500 text-sm mb-8">Please register to your account</p>
        <form className="w-full max-w-xs space-y-4">
          ...
          <button type="submit" className="w-full py-2 bg-indigo-600 text-white rounded-full font-semibold mt-4">Register</button>
        </form>
        ...
        <div className="flex justify-center mt-4 text-sm">
          ...
          <button className="ml-2 text-indigo-600 hover:underline" onClick={() => navigate("/login")}>Login</button>
        </div>
      </div>
    </div>
  );
